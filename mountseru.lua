...
pcall(function()
    for _, g in ipairs(player.PlayerGui:GetChildren()) do
        if g.Name == "MountSeru" then g:Destroy() end
    end
end)
...
local function runSequence()
    ...
    task.spawn(function()
        ...
        notif("Mount Seru", "Sudah tiba di GoPay. Claim sekarang.")
...
print("Mount Seru Script | By Alfian | F9 toggle")
